"""Render and qualify the B4B.4J CMND candidate end to end."""
...
SCRATCH = ROOT / "scratch/b4b4j"
OUTPUT = ROOT / "artifacts/alpha01b/b4b4j_audio_equivalence.txt"
RESIDUAL = ROOT / "artifacts/alpha01b/b4b4j_audio_residual.wav"


def render(name: str, cmnd: str) -> tuple[pathlib.Path, str]:
    ...
    command = [
        ...
        "--lpc-energy", "compensated", "--yin-cmnd", cmnd,
...
def main() -> int:
    ...
    lines = [
        "Stage B4B.4J — YIN CMND Vocal Audio Equivalence",
        "",
        ...
        "oracle=YIN_CMND_REFERENCE_DOUBLE",
        "candidate=YIN_CMND_F32_COMPENSATED",
        f"sample_rate={rate}",
        "",
