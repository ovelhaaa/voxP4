"""Flash and capture the Stage B4B.4J ESP32-P4 audit."""
...
OUT = ROOT / "artifacts" / "alpha01b" / "b4b4j_full_worker.txt"
...
def capture(port: str, timeout: float) -> int:
    ...
    return 0 if re.search(r"B4B\.4J RESULT:\s*PASS", text) else 2
