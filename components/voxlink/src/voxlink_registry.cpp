...
const ParamDescriptor kParams[] = {
    ...
    PENUM(0x0601, "chorus.mode", "Chorus Mode", 0.0f, 2.0f, 0.0f, "chorus",
          "ChorusMode"),
    PFLOAT(0x0602, "chorus.mix", "Chorus Mix", "", 0.0f, 1.0f, 0.35f, 0.01f,
           kPersistRtSmoothed, 20.0f, "chorus", "ChorusMix"),
    PBOOL(0x0603, "chorus.sync_enable", "Chorus Sync", 0.0f, kPersistRt, "chorus",
          "ChorusSyncEnabled"),
    PFLOAT(0x0604, "chorus.rate_hz", "Chorus Rate", "Hz", 0.05f, 10.0f, 1.2f,
    ...
    PFLOAT(0x0606, "chorus.depth_ms", "Chorus Depth", "ms", 0.1f, 15.0f, 2.5f,
