...
const ParamDescriptor kParams[] = {
    ...
    PFLOAT(0x0111, "harmony.dry_alignment.ms", "Dry Alignment Delay", "ms",
           ...
           "DryAlignmentMs"),
    // Semantic enum: 0 NearestScale, 1 PreserveChromatic, 2 BypassHarmony.
    PENUM(0x0112, "harmony.voice1.non_scale_policy", "Harmony Non-Scale Policy",
          0.0f, 2.0f, 0.0f, "harmony", "HarmonyVoice1NonScalePolicy"),
    ...
    PFLOAT(0x0303, "delay.feedback", "Delay Feedback", "", -0.95f, 0.95f, 0.25f,
    ...
    PBOOL(0x0603, "chorus.sync_enable", "Chorus Sync", 0.0f, kPersistRt, "chorus",
          "ChorusSyncEnabled"),
    PFLOAT(0x0604, "chorus.rate_hz", "Chorus Rate", "Hz", 0.05f, 10.0f, 0.75f,
           0.01f, kPersistRtSmoothed, 0.0f, "chorus", "ChorusRateHz"),
    PENUM(0x0605, "chorus.subdivision", "Chorus Subdivision", 0.0f, 12.0f, 1.0f,
          "chorus", "ChorusSubdivision"),
    PFLOAT(0x0606, "chorus.depth_ms", "Chorus Depth", "ms", 0.1f, 15.0f, 1.6f,
           0.1f, kPersistRtSmoothed, 0.0f, "chorus", "ChorusDepthMs"),
    PFLOAT(0x0607, "chorus.base_delay_ms", "Chorus Base Delay", "ms", 1.0f, 30.0f,
    ...
    PENUM(0x0701, "drive.mode", "Drive Mode", 0.0f, 2.0f, 0.0f, "drive",
          "DriveMode"),
    PFLOAT(0x0702, "drive.drive", "Drive Amount", "", 0.0f, 1.0f, 0.40f, 0.01f,
           kPersistRtSmoothed, 20.0f, "drive", "DriveDrive"),
    PFLOAT(0x0703, "drive.tone", "Drive Tone", "", 0.0f, 1.0f, 0.65f, 0.01f,
           kPersistRtSmoothed, 20.0f, "drive", "DriveTone"),
    PFLOAT(0x0704, "drive.mix", "Drive Mix", "", 0.0f, 1.0f, 0.75f, 0.01f,
           kPersistRtSmoothed, 20.0f, "drive", "DriveMix"),
    PFLOAT(0x0705, "drive.output_level", "Drive Output Level", "", 0.0f, 2.0f,
           0.95f, 0.01f, kPersistRtSmoothed, 20.0f, "drive", "DriveOutputLevel"),
};
