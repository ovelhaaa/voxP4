...
void vocal_fx_set_non_scale_policy(size_t voice, NonScaleNotePolicy policy);
void vocal_fx_set_voice_leading(size_t voice, bool enabled);
void vocal_fx_set_harmony_range(size_t voice, int min_midi, int max_midi);
